...
export const dynamicFrom = (tableName: string) => {
  // Cast to any to bypass TypeScript's type checking for dynamic table names
  // This is necessary for runtime-determined table names that can't be statically checked
